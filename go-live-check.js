...
const checks = [
  ...
  ["live partial lead search", index.includes('id="globalSearchResults"') && app.includes("liveLeadSearchMatches") && app.includes('els.globalSearchResults.addEventListener("click"') && app.includes('event.key === "ArrowDown"')],
